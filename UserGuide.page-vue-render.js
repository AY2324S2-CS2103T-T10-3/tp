...
with(this){return _c('h3',{attrs:{"id":"invite-person-to-selected-event-invite"}},[_v("Invite person to selected event: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("invite")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#invite-person-to-selected-event-invite","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Format:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("invite <participant index>")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Description:")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("invite 5")]),_v(" Adds participant indexed 5 to selected event.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Format:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("editp <participant index> -n <participant name> -p PHONE -e EMAIL")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Description:")])])}
},function anonymous(
